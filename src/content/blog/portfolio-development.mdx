...
（余談ですが、Nodeのバージョン管理は最近`nvm`から`fnm`に乗り換えました。これも爆速で`cd`時の自動切り替えもあり良かったです。新しい技術を使うの大事。）
...
<LinkCard url="https://daisyui.com/" />
